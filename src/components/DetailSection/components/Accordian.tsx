...
import {AccordianProps, IconTypeMapperType  } from './types';
const iconType = {
                ...
                {open && data.map(i => (
                    <div className="flex justify-start border-b-[1px] mt-2 mx-2 pb-2">
                        <div className="w-[15%] flex justify-center items-center">
                            <img className={`p-2 rounded-lg ${(iconType  as IconTypeMapperType)[i.transactionType].bgcolor}`} src={(iconType  as IconTypeMapperType)[i.transactionType].icon} width='32px' height='32px' alt={i.transactionType} />
                        </div>
